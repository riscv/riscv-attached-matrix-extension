= Attached Matrix Extension (Zvame)
Authors: Derek Hower, Luca Maroncelli, Eric Mahurin, Siqi Zhao, Qiu Jing, Xiang Xiaoyan
include::../docs-resources/global-config.adoc[]
:docgroup: AME TG
:description: Attached Matrix Extension (Zvame)
ifdef::build-commit[]
:version-label: Commit
:revnumber: {build-commit}
endif::[]
ifdef::build-time[]
:revdate: Built {build-time}
endif::[]
ifdef::revremark[]
endif::[]
...
include::programming_model.adoc[]
...
The AME specification is formally defined in this specification using
https://dhower-qc.github.io/riscv-unified-db/docs/idl[ISA Description Language (IDL)].
